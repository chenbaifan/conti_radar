...
private:
    ...
    std::unique_ptr<tf2_ros::MessageFilter<radar_driver::Radar_Target>> tf2_filter_;
    ...
    custom_msgs::objectList
        convert_to_map_frame(const std::shared_ptr<radar_driver::Radar_Target> detections);
    void radar_callback(const radar_driver::Radar_Target::ConstPtr detections);
    void received_radar(const radar_driver::Radar_Target::ConstPtr detections);

    void compensate_ego_motion(const std::shared_ptr<radar_driver::Radar_Target> detections);
